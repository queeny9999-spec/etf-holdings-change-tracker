...
const official = {
  '00981A': { date: '2026/09/22', nav: '30.30', stockWeight: '97.595%', url: 'https://www.ezmoney.com.tw/ETF/Fund/Info?FundCode=49YTW', rows: [
  ...
  '00403A': { date: '2026/09/22', nav: '10.76', stockWeight: '93.137%', url: 'https://www.ezmoney.com.tw/ETF/Fund/Info?FundCode=63YTW', rows: [
...
function parseFuhwa() {
  ...
  return { date, nav, stockWeight, url: 'https://www.fhtrust.com.tw/ETF/etf_detail/ETF23#stockhold', rows };
}
